...
include 'actions/general-functions.php';
include 'components/header.php';

include 'components/navbar-1.php';
    ...
    <section class="d-flex flex-column">
      <div style="background-image: url('images/bg-home-01.jpg')"
        ...
        <div class="container pt-lg-15 py-8" data-animate="zoomIn">
          ...
          <h2 class="text-white display-2 text-center mb-sm-13 mb-8">
              ...
              <div class="row align-items-center" id="accordion-4">
                ...
                <div id="advanced-search-filters-4" class="col-12 pt-4 pb-sm-4 order-sm-5 order-4 collapse"
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3 pt-6">
                      <label class="text-uppercase font-weight-500 letter-spacing-093 mb-1">All Cities</label>
                      <select
                        class="form-control selectpicker bg-transparent border-bottom rounded-0 border-color-input"
                  ...
                  <div class="row pt-2">
                    ...
                    <div class="col-sm-6 col-lg-3 pt-6">
                      <label class="text-uppercase font-weight-500 letter-spacing-093 mb-1">Property ID</label>
                      <input type="text" name="search"
                    ...
                    <div class="col-12 pt-6 pb-2">
                      <a class="lh-17 d-inline-block other-feature collapsed" data-toggle="collapse"
                        href="#other-feature-4" role="button" aria-expanded="false" aria-controls="other-feature-4">
              ...
              <div class="col-12">
                <div class="form-group mb-0 position-relative">
                  <a href="#advanced-search-filters-4-mobile"
                    ...
                    data-toggle="collapse" data-target="#advanced-search-filters-4-mobile" aria-expanded="true"
                  ...
                  <div class="collapse row mx-0 w-100" id="other-feature-4-mobile">
                    <div class="col-sm-6 py-2">
                      <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="check1-4-mobile">Air Conditioning</label>
                      </div>
                    </div>
                    <div class="col-sm-6 py-2">
                      <div class="custom-control custom-checkbox">
                    ...
                    <div class="col-sm-6 py-2">
                      <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="check11-4-mobile">Swimming Pool</label>
                      </div>
                    </div>
                    <div class="col-sm-6 py-2">
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" name="features[]" id="check12-4-mobile" />
                        <label class="custom-control-label" for="check12-4-mobile">Window Coverings</label>
                      </div>
                    </div>
                    <div class="col-sm-6 py-2">
                      <div class="custom-control custom-checkbox">
                    ...
                    <div class="col-sm-6 py-2">
                      <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="check14-4-mobile">Outdoor Shower</label>
                      </div>
                    </div>
                    <div class="col-sm-6 py-2">
                      <div class="custom-control custom-checkbox">
        ...
        <div class="slick-slider slick-dots-mt-0 custom-arrow-spacing-30"
            ...
            <div class="card shadow-hover-2" data-animate="zoomIn">
              ...
              <div class="card-body pt-3">
                <h2 class="card-title fs-16 lh-2 mb-0">
                  <a href="single-property-2.html" class="text-dark hover-primary">Home in Metric Way</a>
                </h2>
          ...
          <div class="box pb-7 pt-2">
            <div class="card shadow-hover-2" data-animate="zoomIn">
              ...
              <div class="card-body pt-3">
                <h2 class="card-title fs-16 lh-2 mb-0">
                  <a href="single-property-2.html" class="text-dark hover-primary">Affordable Urban House</a>
                </h2>
                <p class="card-text font-weight-500 text-gray-light mb-2">
                  1421 San Pedro St, Los Angeles
                </p>
          ...
          <div class="box pb-7 pt-2">
            <div class="card shadow-hover-2" data-animate="zoomIn">
              ...
              <div class="card-body pt-3">
                <h2 class="card-title fs-16 lh-2 mb-0">
                  <a href="single-property-2.html" class="text-dark hover-primary">Villa on Hollywood Boulevard</a>
                </h2>
                <p class="card-text font-weight-500 text-gray-light mb-2">
                  1421 San Pedro St, Los Angeles
                </p>
        ...
        <div class="container container-xxl">
          <div class="row">
            <div class="col-lg-4 pr-xl-13" data-animate="fadeInLeft">
              ...
              <a href="listing-full-map-1.html" class="btn btn-lg text-secondary btn-accent">+2300 Available Properties
                <i class="far fa-long-arrow-right ml-1"></i>
              </a>
            </div>
        ...
        <div class="slick-slider slick-dots-mt-0 custom-arrow-spacing-30"
          ...
          <div class="box box pb-7 pt-2" data-animate="fadeInUp">
            <div class="card shadow-hover-2">
              ...
              <div class="card-footer bg-transparent d-flex justify-content-between align-items-center py-3">
                <p class="fs-17 font-weight-bold text-heading mb-0">
                  $550<span class="text-gray-light font-weight-500 fs-14">
                    / month</span>
                </p>
                <ul class="list-inline mb-0">
                  <li class="list-inline-item">
          ...
          <div class="box box pb-7 pt-2" data-animate="fadeInUp">
            <div class="card shadow-hover-2">
              ...
              <div class="card-footer bg-transparent d-flex justify-content-between align-items-center py-3">
                <p class="fs-17 font-weight-bold text-heading mb-0">
                  $5.700<span class="text-gray-light font-weight-500 fs-14">
                    / year</span>
                </p>
                <ul class="list-inline mb-0">
                  <li class="list-inline-item">
        ...
        <div class="slick-slider mx-n2"
            ...
            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
              ...
              <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                <h2 class="card-title mb-0 fs-20 lh-182">
                  <a href="single-property-1.html" class="text-white">Lahore</a>
                </h2>
                <p class="card-text fs-13 font-weight-500 letter-spacing-087">
                  FROM<span class="ml-2 fs-15 font-weight-bold">$540.000 - $900.000</span>
                </p>
              </div>
            </div>
          </div>
          <div class="box px-2" data-animate="fadeInUp">
            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
              ...
              <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                <h2 class="card-title mb-0 fs-20 lh-182">
                  <a href="single-property-1.html" class="text-white">Karachi</a>
                </h2>
                <p class="card-text fs-13 font-weight-500 letter-spacing-087">
                  FROM<span class="ml-2 fs-15 font-weight-bold">$520.000 - $700.000</span>
                </p>
              </div>
            </div>
          </div>
          <div class="box px-2" data-animate="fadeInUp">
            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
              ...
              <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                <h2 class="card-title mb-0 fs-20 lh-182">
                  <a href="single-property-1.html" class="text-white">Fasialbad</a>
                </h2>
                <p class="card-text fs-13 font-weight-500 letter-spacing-087">
                  FROM<span class="ml-2 fs-15 font-weight-bold">$340.000 - $600.000</span>
                </p>
              </div>
            </div>
          </div>
          <div class="box px-2" data-animate="fadeInUp">
            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
              ...
              <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                <h2 class="card-title mb-0 fs-20 lh-182">
                  <a href="single-property-1.html" class="text-white">India</a>
                </h2>
                <p class="card-text fs-13 font-weight-500 letter-spacing-087">
                  FROM<span class="ml-2 fs-15 font-weight-bold">$240.000 - $660.000</span>
                </p>
              </div>
            </div>
          </div>
          <div class="box px-2" data-animate="fadeInUp">
            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
              ...
              <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                ...
                <p class="card-text fs-13 font-weight-500 letter-spacing-087">
                  FROM<span class="ml-2 fs-15 font-weight-bold">$380.000 - $680.000</span>
                </p>
              </div>
            </div>
          </div>
