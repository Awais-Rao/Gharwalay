    ...
    <div class="container container-xxl">
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-6 mb-md-0">
                <a class="d-block mb-2" href="#">
                    <img src="images/logo-white.png" alt="Gharwalay" />
                </a>
                <div class="lh-26 font-weight-500">
                    <p class="mb-0">58 Howard Street #2 San Francisco</p>
                    <a class="d-block text-muted hover-white" href="#">contact@gharwalay.com</a>
                    <a class="d-block text-lighter font-weight-bold fs-15 hover-white"
                        href="tel:(+68)122109876">(+68)1221
                        09876</a>
                    <a class="d-block text-muted hover-white" href=".html">www.gharwalay.com</a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-6 mb-md-0">
                ...
                <form>
                    <div class="input-group input-group-lg mb-6">
                        <input type="email" name="email" class="form-control bg-white shadow-none border-0 z-index-1"
        ...
        <div class="mt-0 mt-md-10 row">
            ...
            <p class="col-md-auto mb-0 text-muted">
                © 2020 gharwalay. All Rights Reserved
            </p>
        </div>
    </div>
</footer>
